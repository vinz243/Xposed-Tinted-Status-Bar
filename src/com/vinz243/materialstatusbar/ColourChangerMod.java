...
import com.vinz243.materialstatusbar.drawables.OverlayDrawable;
import com.vinz243.materialstatusbar.hooks.ActionBarHooks;
import com.vinz243.materialstatusbar.hooks.ActivityOnResumeHook;
import com.vinz243.materialstatusbar.hooks.BatteryHooks;
import com.vinz243.materialstatusbar.hooks.BluetoothControllerHook;
import com.vinz243.materialstatusbar.hooks.KitKatBatteryHook;
import com.vinz243.materialstatusbar.hooks.NavigationBarHook;
import com.vinz243.materialstatusbar.hooks.OnWindowFocusedHook;
import com.vinz243.materialstatusbar.hooks.SignalClusterHook;
import com.vinz243.materialstatusbar.hooks.StatusBarHook;
import com.vinz243.materialstatusbar.hooks.StatusBarLayoutInflationHook;
import com.vinz243.materialstatusbar.hooks.StatusBarViewHook;
import com.vinz243.materialstatusbar.hooks.TickerHooks;
import com.vinz243.materialstatusbar.hooks.WindowDecorActionBarHooks;
import com.vinz243.materialstatusbar.hooks.WindowDimHooks;
import com.vinz243.materialstatusbar.hooks.oemhooks.CustomRomHooks;
import com.vinz243.materialstatusbar.hooks.oemhooks.HtcTransparencyHook;
import com.vinz243.materialstatusbar.hooks.oemhooks.LGHooks;
import com.vinz243.materialstatusbar.hooks.oemhooks.SViewHooks;
import com.vinz243.materialstatusbar.hooks.oemhooks.SamsungHook;
...
public class ColourChangerMod implements IXposedHookLoadPackage, IXposedHookZygoteInit, IXposedHookInitPackageResources {
	...
	private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			} else if ("com.vinz243.materialstatusbar.PROFILE_MEMORY_USAGE".equals(intent.getAction())) {
	...
	@SuppressLint("NewApi")
	public void setStatusBarTint(int tintColor) {

		if (mStatusBarView == null)
			return;

		log("Setting statusbar color to " + tintColor);
        if(mSettingsHelper.getBoolean("pref_darker_color", true)) {
            int r = Color.red(tintColor);
            int g = Color.green(tintColor);
            int b = Color.blue(tintColor);
            tintColor = Color.rgb(r >= 16 ? r - 16 : r, g >= 18 ? g - 18 : g, b >= 22 ? b - 22 : b);
        }
        //Log.d("ViewListing", "#" + Integer.toHexString(r) + Integer.toHexString(g) + Integer.toHexString(b) + ":" + Integer.toHexString(tintColor));
